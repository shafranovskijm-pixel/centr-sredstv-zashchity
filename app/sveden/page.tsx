      ...
      <div className="sveden-layout">
        ...
        <div className="sveden-content">
          ...
          <section className="info-section" id="objects">
            ...
            <p>Для обучения планируется использовать электронную образовательную среду «Синтагма». Учебный курс на 34 академических часа и электронная библиотека проходят подготовку и проверку; доступ к обучению пока не открыт. В проекте предусмотрены два модуля и четыре часа дистанционных самостоятельных профессиональных заданий.</p>
