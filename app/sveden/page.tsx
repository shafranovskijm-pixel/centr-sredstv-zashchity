      ...
      <div className="sveden-layout">
        ...
        <div className="sveden-content">
          ...
          <section className="info-section" id="document">
            ...
            <div className="draft-notice"><strong>Статус учебных документов</strong><p>Программа на 34 часа и учебные документы доступны ниже в PDF для ознакомления и утверждения. Утверждённые редакции будут размещены после оформления. До получения лицензии образовательная деятельность не осуществляется.</p></div>
            <div className="download-pack">
              <div>
                <span>Программа повышения квалификации</span>
                <strong>34 академических часа · 2 модуля</strong>
                <p>Доступны полный текст ДПП, рабочие программы, задания и порядок контроля. Утверждённая редакция готовится к публикации.</p>
          ...
          <section className="info-section" id="education">
            ...
            <article className="program-record">
              ...
              <dl>
                ...
                <div><dt>Выбранный вид работ</dt><dd>Монтаж, техническое обслуживание и ремонт первичных средств пожаротушения</dd></div>
                <div><dt>Объём</dt><dd>34 академических часа</dd></div>
                <div><dt>Срок освоения</dt><dd>5 учебных дней</dd></div>
          ...
          <section className="info-section" id="objects">
            ...
            <p>Для обучения планируется использовать электронную образовательную среду «Синтагма». Курс на 34 академических часа и электронная библиотека созданы; полный учебный сценарий проходит проверку, доступ к обучению пока не открыт. Предусмотрены два модуля и четыре часа дистанционных самостоятельных профессиональных заданий.</p>
