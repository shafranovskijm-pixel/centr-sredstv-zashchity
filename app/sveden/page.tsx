      ...
      <div className="sveden-layout">
        ...
        <div className="sveden-content">
          ...
          <section className="info-section" id="document">
            ...
            <div className="download-pack">
              <div>
                ...
                <strong>18 документов PDF</strong>
          ...
          <section className="info-section" id="objects">
            ...
            <p>Для размещения учебных материалов, взаимодействия со слушателями, контроля освоения программы и дистанционной аттестации используется образовательная платформа <a href="https://синтагма.рф/">«Синтагма»</a> по договору от 30.07.2026 № СДО-ЦСЗ-01/2026. Срок предоставления доступа — по 29.07.2027. Данные доступа на сайте не публикуются.</p>
          </section>
