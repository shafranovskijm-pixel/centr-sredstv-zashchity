...
const documentGroups = [
  {
    title: "Подписанные документы, полученные от руководителя",
    documents: [
  ...
  {
    title: "Документ, ожидающий подписи руководителя",
    documents: [
      ...
      <div className="sveden-layout">
        ...
        <div className="sveden-content">
          ...
          <section className="info-section" id="document">
            ...
            <div className="draft-notice"><strong>Получены подписанные документы</strong><p>Договор с платформой «Синтагма» и приказы № 1-ОД, № 2-ОД и № 3-ОД опубликованы в виде PDF, присланных генеральным директором ответным письмом. Сведения о материально-техническом обеспечении и ЭИОС пока размещены без подписи. Локальные акты утверждены приказом № 3-ОД, образовательная программа — приказом № 2-ОД. Образец договора с будущим обучающимся не подписывается заранее.</p></div>
