    ...
    <main className="internal-page">
      ...
      <section className="program-body" id="program-plan">
        ...
        <div>
          ...
          <div className="legal-note"><strong>Проект реализации в ЭИОС</strong><p>Каждый из 11 модулей включает 14 часов теории и 2 часа практических занятий. В модулях 1–7 и 9–11 предусмотрены десять самостоятельных документарных ситуационных заданий общей продолжительностью 20 часов. В модуле 8 предусмотрено отдельное двухчасовое синхронное дистанционное наблюдение реального объекта. Письменные результаты сохраняются в ЭИОС и проверяются преподавателем.</p><p>Промежуточная аттестация проводится по каждому из 11 модулей и входит в их нагрузку. Итоговая аттестация — комплексный экзамен продолжительностью 2 часа — оценивает теоретическую и практическую подготовленность. До успешного завершения промежуточной аттестации слушатель к экзамену не допускается.</p></div>
          <div className="legal-note"><strong>Условия проведения модуля 8</strong><p>{module8Notice}</p></div>
          <div className="legal-note"><strong>Статус программы и курса</strong><p>Программа не утверждена. Учебные документы представлены ниже для утверждения. Подписанная утверждённая редакция пока не опубликована. Курс на 178 часов и электронные учебные материалы на платформе «Синтагма» доступны проверяющему после входа в СДО. Доступ к обучению пока не открыт; набор закрыт до получения образовательной лицензии.</p></div>
          <ProgramDownloads />
        </div>
      </section>
    </main>
