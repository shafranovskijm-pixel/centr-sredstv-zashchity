...
const curriculum = programModules.map((title, index) => ({
  ...
  title,
  text: "16 часов: 14 часов теории и 2 часа самостоятельной практической работы с дистанционной проверкой.",
}));
      ...
      <section className="section course-section" id="program">
        <div className="section-heading">
          ...
          <p>
            ...
            154 часа теории, 22 часа самостоятельных практических работ и
            ...
            Условия реализации модуля 8 уточняются до утверждения проекта.
          </p>
        </div>
