...
const curriculum = [
  ...
  {
    number: "02",
    title: "Безопасность работ",
    text: "Опасности, организационные меры безопасности и первая помощь.",
  },
  {
    number: "03",
    title: "Первичные средства пожаротушения",
    text: "Назначение, выбор, размещение и ограничения применения.",
  },
  {
    number: "04",
    title: "Обслуживание и учет",
    text: "Контроль состояния, техническое обслуживание, ремонт и оформление документации.",
  },
  {
    number: "05",
    title: "Самостоятельные профессиональные задания",
    text: "Дистанционный документарный анализ и расчетная задача с условными учебными данными.",
  },
  {
    number: "06",
    title: "Итоговая аттестация",
    text: "Итоговый тест и комплексная письменная работа.",
  },
];
    ...
    <main>
          ...
          <div className="hero-copy">
            ...
            <div className="facts" aria-label="Основные параметры программы">
              <div className="fact-card">
                <ClockIcon />
                <span><strong>34</strong> академических часа</span>
              </div>
              <div className="fact-card">
                <LaptopIcon />
      ...
      <section className="section course-section" id="program">
        <div className="section-heading">
          <div>
            ...
            <h2>Компетенции для работы с первичными средствами пожаротушения</h2>
          </div>
          <p>
            Разработан проект на 34 академических часа: общепрофессиональный модуль
            и модуль по монтажу, техническому обслуживанию и ремонту первичных
            средств пожаротушения. Теория — 28 часов, дистанционные самостоятельные
            профессиональные задания — 4 часа, итоговая аттестация — 2 часа. Утверждённая редакция будет размещена после завершения
            согласования. Обучение начнётся после получения лицензии.
          </p>
        </div>
      ...
      <section className="section process-section" id="education">
        ...
        <ol className="steps">
          ...
          <li><span>2</span><div><strong>Освоение программы</strong><p>Материалы, дистанционные самостоятельные профессиональные задания и промежуточная аттестация.</p></div></li>
