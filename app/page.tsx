    ...
    <main>
      ...
      <section className="section course-section" id="program">
        <div className="section-heading">
          ...
          <p>
            Программа на 178 академических часов включает 11 модулей по 16 часов:
            ...
            Доступен подписанный экземпляр программы; в документе указан приказ от 31 июля 2026 года № 4-ОД. Набор закрыт до получения образовательной лицензии.
      ...
      <section className="section process-section" id="education">
        <div className="process-copy">
          ...
          <p>
            ...
            образовательной среде. Учебный курс и электронные материалы доступны
            проверяющему после входа в СДО; доступ к обучению пока не открыт.
          </p>
        </div>
        <ol className="steps">
