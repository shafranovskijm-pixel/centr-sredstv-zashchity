    ...
    <main>
      ...
      <section className="section course-section" id="program">
        <div className="section-heading">
          ...
          <p>
            Разработан рабочий проект редакции на 178 часов: 11 модулей с теорией,
            практической работой и промежуточной аттестацией, а также итоговая
            аттестация. Утверждённая редакция будет размещена после завершения
